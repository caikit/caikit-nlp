...
# Local
from caikit_nlp.data_model import GenerationTrainRecord, LoraTuningConfig, TuningConfig
...
def parse_args() -> argparse.Namespace:
    ...
    parser_LoRA_tuning = subparsers.add_parser(
        "LORA",
        help="Train prompt vectors through LoRA Tuning.",
    ...
    register_lora_tuning_args(parser_LoRA_tuning)
...
def register_lora_tuning_args(subparser: argparse.ArgumentParser):
    ...
    subparser.add_argument(
        "--bias",
        help="Specifies if the bias parameters should be trained.",
        type = str,
        default = "none",
...
def build_lora_config(args: argparse.Namespace, dataset_info: DatasetInfo):
    ...
    return LoraTuningConfig(**base_kwargs)
...
if __name__ == "__main__":
    ...
    tuning_config = build_lora_config(args)
